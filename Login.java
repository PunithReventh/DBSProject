...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:dbproject", "project", "orcl");
        ...
        try {
            ...
            if(mdpass.equalsIgnoreCase(actPass) == true){
                switch(actRID){
                    case 1:
                        PreparedStatement getStudName = connection.prepareStatement("SELECT STUDENTNAME FROM STUDENT WHERE STUDENTEMAIL = ?");
                        getStudName.setString(1,User);
                        ResultSet getStudNameRS = getStudName.executeQuery();
                        while(getStudNameRS.next()){
                            userName = getStudNameRS.getString(1);
                        }
