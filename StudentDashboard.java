...
public class StudentDashboard extends javax.swing.JFrame {
    ...
    static String SId = Login.getStudentId();
    /**
        ...
        for(int i=0;i<data.size();i++)
        {
            ...
            if((boolean) rowData.get(9) == true)
            {
                ...
                try {
                    ...
                    if(applied.next())
                    {
                        jLabel14.setText("You already applied for "+(String) rowData.get(2));
                    }
                    else
                    {    
                        ...
                        if(updt1 == 1)
                            jLabel14.setText("Applied Successfully!");
                        else
                            jLabel14.setText("Error! Apply again");
                    }    
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if(updt2 == 1)
                jLabel7.setText("Submitted successfully!");
            else
                jLabel7.setText("Invalid data, try again!"); 
        } catch (SQLException ex) {
            Logger.getLogger(FacultyDashboard.class.getName()).log(Level.SEVERE, null, ex);
        }
        jTextField1.setText("");
            ...
            if((boolean) rowData2.get(3) == true)
            {
                ...
                try {
                    ...
                    while(foundOrgId.next())
                    {
                        ...
                        if(updt4==1)
                            jLabel17.setText("Successfully confirmed your internship!");
                        else
                            jLabel17.setText("Couldn't update, try again");
                    }
                } catch (SQLException ex) {
                    Logger.getLogger(StudentDashboard.class.getName()).log(Level.SEVERE, null, ex);
                }   
